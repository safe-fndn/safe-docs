---
title: 'Safe and ERC-4337'
description: 'How to use ERC-4337 with Safe Smart Accounts'
---
...
Safe ERC-4337 compatibility is provided via [Safe Modules](/more/glossary.md#safe-module) and the Fallback Handler. This means the functionality is not implemented directly in the Safe Smart Account, but in the [Safe4337Module](https://github.com/safe-global/safe-modules/blob/main/modules/4337/contracts/Safe4337Module.sol) contract, which can be enabled in any Safe account at the Safe deployment time or afterward.

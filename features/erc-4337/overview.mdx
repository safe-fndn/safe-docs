...
<Columns cols={3}>
  <Card title="Flexibility of payments" href="javascript:void(0)">
    Users can decide how to pay the gas fees. Use native tokens like ETH, ERC-20 tokens, or even sponsored transactions.
  </Card>
  <Card title="Freedom of Authentication" href="javascript:void(0)">
  ...
  <Card title="Decentralization" href="javascript:void(0)">

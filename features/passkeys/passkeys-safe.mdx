---
title: 'Safe and Passkeys'
description: 'How to use Passkeys with Safe Smart Accounts'
---
...
New signers can be deployed using the [ISafeSignerFactory](https://github.com/safe-fndn/safe-modules/blob/466a9b8ef169003c5df856c6ecd295e6ecb9e99d/modules/passkey/contracts/interfaces/ISafeSignerFactory.sol) interface and this factory contract address.
...
- [Passkeys module](https://github.com/safe-fndn/safe-modules/blob/466a9b8ef169003c5df856c6ecd295e6ecb9e99d/modules/passkey/README.md)
- [Safe and Passkeys demo application](https://github.com/safe-fndn/safe-modules/tree/main/examples/4337-passkeys)
- [4337 support for passkeys](https://github.com/safe-fndn/safe-modules/tree/main/modules/passkey/contracts/4337)
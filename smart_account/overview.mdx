...
![Safe Smart Accounts Architecture](/images/diagram-safe-smart-accounts-architecture.png)
...
For more information, refer to the [Safe Singleton Factory](https://github.com/safe-fndn/safe-singleton-factory) repository.
...
![Safe Smart Account Components](/images/diagram-safe-smart-account-safe-components.png)
...
![Safe Proxy Creation](/images/diagram-safe-smart-account-proxy-creation.png)

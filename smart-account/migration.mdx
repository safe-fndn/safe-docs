---
title: "Migration"
description: "Safe Smart Account Migration"
---
...
Finding the address of the new Singleton contract is the first step in the migration process. Safe maintains [SafeMigration](https://github.com/safe-fndn/safe-smart-account/blob/main/contracts/libraries/SafeMigration.sol) contract to update the Singleton contract address in the `SafeProxy` contract.

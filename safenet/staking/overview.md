...
The Staking contract source is available on GitHub: [Staking.sol](https://github.com/safe-research/safenet/blob/main/contracts/src/Staking.sol). It is [audited](/safenet/security).

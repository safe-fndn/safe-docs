...
flowchart LR
    ...
    classDef orange  fill:#f07030,stroke:#f07030,color:#ffffff

    A[Transaction proposed]:::neutral --> B[Validators evaluate]:::neutral
    B -->|Rules satisfied| C[Onchain attestation]:::green
    B -->|Rules not met|  D[No attestation]:::orange
    C --> E[Safe Guard verifies onchain]:::green
    E --> F[Transaction executes]:::green
    D --> G[Execution requirements not met]:::orange
```
